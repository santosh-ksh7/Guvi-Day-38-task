// The dataset on which the queries below mentioned are performed
...
// The Queries on product data to be performed
...
db.products.find({product_price : {$not : {$gte :400 , $lte :600}} }).toArray()
